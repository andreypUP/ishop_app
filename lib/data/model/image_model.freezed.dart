...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String url, String? blurHash});
}
...
class _$ImageModelImpl implements _ImageModel {
  const _$ImageModelImpl(
      {required this.id, required this.url, required this.blurHash});
  ...
  @override
  String toString() {
    return 'ImageModel(id: $id, url: $url, blurHash: $blurHash)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, url, blurHash);
...
abstract class _ImageModel implements ImageModel {
  const factory _ImageModel(
      ...
      required final String? blurHash}) = _$ImageModelImpl;
